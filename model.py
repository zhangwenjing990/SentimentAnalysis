...
import math
from activations import gelu, gelu_new, swish, mish
...
class ClassificationModel(nn.Module):
    ...
    def forward(self, inputs, mask):
        ...
        sequence_output, pooled_output = self.bert(inputs, attention_mask)
        # 获得bert模型最后一层的隐藏状态
        prediction_scores = self.cls(pooled_output)
        prediction_scores = prediction_scores.squeeze(1).softmax(-1)
